...
class StringSetting(private val key: String): ReadWriteProperty<Config, String> {
    override fun getValue(thisRef: Config, property: KProperty<*>) = Config.get(key).orEmpty()
    override fun setValue(thisRef: Config, property: KProperty<*>, value: String) = Config.set(key, value)
}